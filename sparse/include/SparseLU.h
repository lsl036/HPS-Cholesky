...
#define LU_DefaultMethod 0
// 一般实数矩阵的非零元阈值和稀疏度阈值
#define GRnnz_threshold 1750000
#define GRsparsity_threshold 0.0002
// 对称实数矩阵的非零元阈值和稀疏度阈值
#define SRnnz_threshold 400000
#define SRsparsity_up_threshold 0.006
#define SRsparsity_low_threshold 0.00018
// 对称二进制矩阵的非零元阈值和稀疏度阈值
#define SPnnz_threshold 100000
#define SPsparsity_up_threshold 0.011
#define SPsparsity_low_threshold 0.00013
...
int olu_factorization (FILE *fp, FILE *fresult);

int plu_factorization (
    char *fmatrix, 
    FILE *fresult, 
    Sparse_long iparm[], 
    double dparm[]

...
// #define WRITE_GRAPH 1
#define RELAXED_GAMMA 1.0
#define RELAXED_CDENSITY 1.25
/* ========================================================================== */
/* === SparseCore objects ====================================================== */
/* ========================================================================== */
...
typedef struct sparse_csc_struct
{
	...
	*/
     ...
     *     - the properties (SpmGeneral, SpmSymmetric)
     *     - the base value (0 in C)
    ...
    spm_coeftype_t flttype; /**< values datatype: SpmPattern, SpmDouble                         */
    spm_fmttype_t  fmttype; /**< Matrix storage format: SpmCSC, SpmCSR, SpmIJV                  */

    Sparse_long      gN;      /**< Global number of vertices in the compressed graph (Computed)   */
    Sparse_long      n;       /**< Local number of vertices in the compressed graph               */
    Sparse_long      gnnz;    /**< Global number of non zeroes in the compressed graph (Computed) */
    Sparse_long      nnz;     /**< Local number of non zeroes in the compressed graph             */

    Sparse_long      gNexp;   /**< Global number of vertices in the compressed graph (Computed)   */
    Sparse_long      nexp;    /**< Local number of vertices in the compressed graph (Computed)    */
    Sparse_long      gnnzexp; /**< Global number of non zeroes in the compressed graph (Computed) */
    Sparse_long      nnzexp;  /**< Local number of non zeroes in the compressed graph (Computed)  */

    Sparse_long      dof;     /**< Number of degrees of freedom per unknown,
    ...
    Sparse_long     *colptr;  /**< List of indirections to rows for each vertex [+baseval]        */
    Sparse_long     *rowptr;  /**< List of edges for each vertex [+baseval]                       */
    Sparse_long     *loc2glob;/**< Corresponding numbering from local to global [+baseval]        */
...
void *SparseCore_read_matrix (FILE *, int, int *, int *, int *, 
#ifdef WRITE_GRAPH
int graph_id,

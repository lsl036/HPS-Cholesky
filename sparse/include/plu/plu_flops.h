...
#define FMULS_SYMM(__side, __m, __n) ( ( (__side) == PluLeft ) ? FMULS_GEMM((__m), (__m), (__n)) : FMULS_GEMM((__m), (__n), (__n)) )
#define FADDS_SYMM(__side, __m, __n) ( ( (__side) == PluLeft ) ? FADDS_GEMM((__m), (__m), (__n)) : FADDS_GEMM((__m), (__n), (__n)) )
...
#define FMULS_TRMM(__side, __m, __n) ( ( (__side) == PluLeft ) ? FMULS_TRMM_2((__m), (__n)) : FMULS_TRMM_2((__n), (__m)) )
#define FADDS_TRMM(__side, __m, __n) ( ( (__side) == PluLeft ) ? FADDS_TRMM_2((__m), (__n)) : FADDS_TRMM_2((__n), (__m)) )
...
#define FMULS_UNMQR(__m, __n, __k, __side) (( (__side) == PluLeft ) ?  ((double)(__n) *  (double)(__k) * (2. * (double)(__m) - (double)(__k) + 2. )) \
                                            :                             ((double)(__k) * ((double)(__m) * (2. * (double)(__n) - (double)(__k) + 1.) + (double)(__n) - .5 * (double)(__k) + .5)))

#define FADDS_UNMQR(__m, __n, __k, __side) (( (__side) == PluLeft ) ?  ((double)(__n) * (double)(__k) * (2. * (double)(__m) - (double)(__k) + 1. )) \
